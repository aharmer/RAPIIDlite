...
# Form implementation generated from reading ui file 'D:/Dropbox/data/RAPIIDlite/GUI/rapiidlite_GUI.ui'
#
...
"}")
        ...
        self.label_selectLabelCam = QtWidgets.QLabel(self.horizontalWidget)
        self.label_selectLabelCam.setObjectName("label_selectLabelCam")
        self.verticalLayout_2.addWidget(self.label_selectLabelCam)
        self.comboBox_selectLabelCam = QtWidgets.QComboBox(self.horizontalWidget)
        self.comboBox_selectLabelCam.setObjectName("comboBox_selectLabelCam")
        self.verticalLayout_2.addWidget(self.comboBox_selectLabelCam)
        self.horizontalLayout_0.addLayout(self.verticalLayout_2)
        self.verticalLayout_7 = QtWidgets.QVBoxLayout()
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.flir_0_exposure_label = QtWidgets.QLabel(self.horizontalWidget)
        self.flir_0_exposure_label.setObjectName("flir_0_exposure_label")
        self.verticalLayout_7.addWidget(self.flir_0_exposure_label)
        self.flir_0_exposure_spinBox = QtWidgets.QSpinBox(self.horizontalWidget)
        self.flir_0_exposure_spinBox.setObjectName("flir_0_exposure_spinBox")
        self.verticalLayout_7.addWidget(self.flir_0_exposure_spinBox)
        self.horizontalLayout_0.addLayout(self.verticalLayout_7)
        self.verticalLayout_8 = QtWidgets.QVBoxLayout()
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.flir_0_gain_label = QtWidgets.QLabel(self.horizontalWidget)
        self.flir_0_gain_label.setObjectName("flir_0_gain_label")
        self.verticalLayout_8.addWidget(self.flir_0_gain_label)
        self.flir_0_gain_spinBox = QtWidgets.QSpinBox(self.horizontalWidget)
        self.flir_0_gain_spinBox.setObjectName("flir_0_gain_spinBox")
        self.verticalLayout_8.addWidget(self.flir_0_gain_spinBox)
        self.horizontalLayout_0.addLayout(self.verticalLayout_8)
        self.verticalLayout_9 = QtWidgets.QVBoxLayout()
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.flir_0_gamma_label = QtWidgets.QLabel(self.horizontalWidget)
        self.flir_0_gamma_label.setObjectName("flir_0_gamma_label")
        self.verticalLayout_9.addWidget(self.flir_0_gamma_label)
        self.flir_0_gamma_spinBox = QtWidgets.QSpinBox(self.horizontalWidget)
        self.flir_0_gamma_spinBox.setObjectName("flir_0_gamma_spinBox")
        self.verticalLayout_9.addWidget(self.flir_0_gamma_spinBox)
...
"}")
        ...
        self.label_selectBarcodeCam = QtWidgets.QLabel(self.horizontalWidget)
        ...
        self.comboBox_selectBarcodeCam = QtWidgets.QComboBox(self.horizontalWidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_selectLabelCam.setText(_translate("MainWindow", "Select camera"))
        self.flir_0_exposure_label.setText(_translate("MainWindow", "Exposure time (us)"))
        self.flir_0_gain_label.setText(_translate("MainWindow", "Gain level (dB)"))
        self.flir_0_gamma_label.setText(_translate("MainWindow", "Gamma correction"))
